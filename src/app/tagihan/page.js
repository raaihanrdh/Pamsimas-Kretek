        ...
        <div className="bg-white shadow-lg p-5">
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center border-b border-gray-300">
                      <button
                        ...
                        className="bg-emerald-500 hover:bg-emerald-600 text-white py-2 px-4 rounded-lg transition duration-200 ease-in-out"
                      >
                        Edit
                      </button>
                    </td>
              ...
              >
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="bg-emerald-500 text-white  py-2 px-6 mt-2 rounded-full"
                  >
                    Edit
                  </button>
                </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-between mb-10 items-center space-y-4 sm:space-y-0 ">
            ...
            <div className="flex items-center space-x-2 ">
              ...
              <span className="px-3 py-2 bg-emerald-500 text-white rounded-lg text-xs sm:text-sm">

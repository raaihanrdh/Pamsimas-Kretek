      ...
      {loading ? (
        ...
        <div className="rounded-lg bg-white shadow-lg p-5">
                        ...
                        <td className="px-6 py-4 flex gap-2">
                          {user.permissions.pelanggan.update === 1 && (
                            <button
                              ...
                              className="bg-emerald-500 text-white hover:bg-emerald-600 py-2 px-4 rounded-lg transition duration-200 flex items-center gap-2"
                            >
                ...
                currentData.map((item) => (
                  ...
                  >
                    ...
                    <div className="mt-2 flex justify-center gap-2">
                      ...
                      <button
                        onClick={() => openModal("edit", item)}
                        className="bg-emerald-500 text-white hover:bg-emerald-600 py-2 px-4 rounded-lg transition duration-200"
                      >
                        Edit
                      </button>
                      <button
          ...
          <div className="mt-4 flex justify-center items-center space-x-2">
            ...
            <span className="px-4 py-2 border rounded-lg bg-emerald-500 text-white">

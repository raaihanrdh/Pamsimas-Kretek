  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white shadow-2xl rounded-2xl overflow-hidden">
        <div className="bg-emerald-400 justify-center text-white p-6 flex items-center space-x-4">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            <label className="flex items-center text-gray-700 font-semibold">
              <FiHome className="mr-2 w-5 h-5 text-emerald-400" />
              Pilih RT/RW
            </label>
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-3 border-2 border-emerald-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all"
              >
          ...
          <div className="space-y-2">
            <label className="flex items-center text-gray-700 font-semibold">
              <FiFileText className="mr-2 w-5 h-5 text-emerald-400" />
              ID Meteran
            </label>
            <input
              type="text"
          ...
          <button
            ...
            className="w-full bg-emerald-400 text-white flex items-center justify-center px-4 py-3 rounded-lg hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          {dataTagihan.length > 0 && (
            <div className="mt-6 space-y-4">
              <h2 className="text-xl font-bold text-gray-800 flex items-center">
                <FiCreditCard className="mr-2 w-6 h-6 text-emerald-400" />
                Detail Tagihan
              </h2>
              {dataTagihan.map((tagihan) => (
                <div
                  key={tagihan.idTagihan}
                  className="bg-white border-2 border-emerald-100 rounded-2xl p-5 shadow-lg hover:shadow-xl transition-all"
                >

      ...
      <div className="relative w-full max-w-lg p-8 bg-white rounded-xl shadow-lg">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full py-2 px-3 border border-gray-400 rounded-md shadow-sm focus:ring-emerald-400 focus:border-emerald-400"
            >
          ...
          <div>
            ...
            <select
              ...
              className="w-full py-2 px-3 border-gray-400 rounded-md border shadow-sm focus:ring-emerald-400 focus:border-emerald-400"
            >
        ...
        <div className="mt-6 flex justify-end space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-emerald-400 rounded-lg shadow-md hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-600"
          >
            {isLoading ? (

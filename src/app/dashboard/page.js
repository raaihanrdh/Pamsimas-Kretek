    ...
    <div className="flex-1 bg-gradient-to-b from-blue-50 to-blue-100 px-4 py-6">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="md:hidden flex bg-white fitems-center text-emerald-600 px-4 py-2 rounded-full hover:bg-400-600 transition border border-emerald-800 duration-300 mb-6"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-emerald-500 shadow-lg rounded-lg p-6 text-center flex items-center justify-between relative group hover:scale-105 transition-transform duration-200">
          <div>

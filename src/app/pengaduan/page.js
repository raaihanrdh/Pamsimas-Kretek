                  ...
                  {(user.permissions.pengaduan.update === 1 ||
                    ...
                    <td className="px-6 py-4 text-center border-b border-gray-300">
                      <div className="relative">
                        {user.permissions.pengaduan.update === 1 && (
                          <select
                            className="bg-white border border-gray-300 rounded-lg shadow-sm py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition duration-200 ease-in-out"
                            onChange={(e) =>
                              handleStatusChange(
                                item.idPengaduan,
                                e.target.value

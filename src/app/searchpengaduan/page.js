...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 px-6 py-8">
          ...
          <div className="flex flex-col sm:w-1/2 space-y-2">
            ...
            <div className="flex w-full">
              ...
              <button
                ...
                className="bg-emerald-400 hover:bg-emerald-500 text-white py-3 px-6 rounded-r-lg"
              >
                Cari
              </button>
            </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <tbody>
                {currentItems.map((item, index) => (
                  <tr
                    ...
                    className={`transition duration-300 ease-in-out hover:bg-emerald-100 ${
          ...
          <div className="flex justify-between mt-6">
            <button
              ...
              className="bg-emerald-400 hover:bg-emerald-500 text-white py-2 px-4 rounded-lg"
            >
              Prev
            </button>
